...
# load the R file containing the datasets
setwd("set-working-folder")
load("data/balls_strikes_count.Rdata") 

############################
# lattice package examples #
############################
...
#####################################
# building a lattice plot ste-by-step
...
# impose isometric scales (uncomment to manually choos colors)
